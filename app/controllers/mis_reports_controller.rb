class MisReportsController < ApplicationController
   ...
   def zone_mis_report
      #current day record(Accepted data)
        ...
        @invoice = Invoice.where('district_name = ? and Date(created_at) = ?',current_user.zone_name, Date.today).find(:all,:select => 'id', :conditions=>"is_invoice = 1", :order=>"id desc")
        ...
        @invoice1 = Invoice.where('district_name = ? and created_at >= ? and Date(created_at) <= ?',current_user.zone_name, (Date.today).beginning_of_month, Date.today).find(:all,:select => 'id', :conditions=>"is_invoice = 1", :order=>"id desc")
        ...
        @invoice2 = Invoice.where('district_name = ?', current_user.zone_name).find(:all,:select => 'id', :conditions=>"is_invoice = 1", :order=>"id desc")
        ...
        @invoice_rej = Invoice.where('district_name = ? and Date(created_at) = ?',current_user.zone_name, Date.today).find(:all,:select => 'id', :conditions=>"is_invoice = 2", :order=>"id desc")
        ...
        @invoice1_rej = Invoice.where('district_name = ? and created_at >= ? and Date(created_at) <= ?',current_user.zone_name, (Date.today).beginning_of_month, Date.today).find(:all,:select => 'id', :conditions=>"is_invoice = 2", :order=>"id desc")
        ...
        @invoice2_rej = Invoice.where('district_name = ?', current_user.zone_name).find(:all,:select => 'id', :conditions=>"is_invoice = 2", :order=>"id desc")
